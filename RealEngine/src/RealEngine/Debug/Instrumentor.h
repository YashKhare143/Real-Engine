...
#define RE_PROFILE 0
    ...
    #define RE_PROFILE_SCOPE(name) ::RealEngine::InstrumentationTimer timer##__LINE__(name);
    #define RE_PROFILE_FUNC() RE_PROFILE_SCOPE(__FUNCSIG__)
#else
    #define RE_PROFILE_BEGIN_SESSION(name, filepath)
    #define RE_PROFILE_END_SESSION()
    #define RE_PROFILE_SCOPE(name)
    #define RE_PROFILE_FUNC()
#endif